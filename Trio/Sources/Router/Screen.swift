...
enum Screen: Identifiable, Hashable {
    ...
    case caregiverMessagingSettings
    case caregiverQuickMessage
    case mealSettings
    case iconConfig
    case overrideConfig
    case snooze
...
extension Screen {
    @ViewBuilder func view(resolver: Resolver) -> some View {
        ...
        case .twilioConfig:
            TwilioConfig.RootView(resolver: resolver)
        case .pumpConfig:
            PumpConfig.RootView(
                resolver: resolver,
                displayClose: false,
        ...
        case .caregiverMessagingSettings:
            CaregiverMessagingSettings.RootView(resolver: resolver)
        case .caregiverQuickMessage:
            CaregiverQuickMessageView(resolver: resolver)
        case .mealSettings:
        ...
        case .deliveryDiagnostics:
            DeliveryDiagnostics.RootView(resolver: resolver)
        }
    }
